...
CLI providers (=AiClaudeCodeClient=, =AiOpenCodeClient=) do not use API keys directly --- they delegate authentication to their respective CLI tools. Optional environment variables:
