...
|----------------------------+------------------+-----------------------------------------+--------------------------|
| [[file:claude.org][Claude]] | =AiClaudeClient= | =ANTHROPIC_API_KEY= or =CLAUDE_API_KEY= | claude-sonnet-4-20250514 |
| [[file:openai.org][OpenAI]] | =AiOpenAIClient= | =OPENAI_API_KEY=                        | gpt-4o                   |
| [[file:gemini.org][Gemini]] | =AiGeminiClient= | =GEMINI_API_KEY=                        | gemini-2.0-flash         |
| [[file:grok.org][Grok]]     | =AiGrokClient=   | =XAI_API_KEY= or =GROK_API_KEY=         | grok-4-1-fast-reasoning  |
